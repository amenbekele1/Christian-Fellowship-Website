...
/**
 * Chat surface shared by BUS groups and service teams.
 *
 * `apiBase` is the collection root for the conversation, e.g.
 *   /api/bus-groups/abc123   or   /api/teams/team_worship
 * It must expose `/messages` (GET, POST, DELETE) and `/upload` (POST).
 */
