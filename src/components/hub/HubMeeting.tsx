...
export default function HubMeeting({ apiBase, roomPrefix, hubName }: { apiBase: string; roomPrefix: string; hubName: string }) {
  const groupName = hubName;
